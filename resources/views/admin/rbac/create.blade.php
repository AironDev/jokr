                ...
                <form class="col-md-12" action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="title">{{ __('Create Roles and Abilities') }}</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Role Name') }}</label>
                                <div class="col-md-9">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Role Title') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                            ...
                            <div class="row">
                                <label class="col-md-3 col-form-label">{{ __('Role Description') }}</label>
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control" placeholder="Email" value="{{ auth()->user()->email }}" required>
                                    </div>
